...
// --------------------------------------------------
	...
	jQuery(".gallery2:first a[data-type^='prettyPhoto']").prettyPhoto({animation_speed:'fast',theme:'pp_default',slideshow:3000, autoplay_slideshow: false});
	jQuery(".gallery2:gt(0) a[data-type^='prettyPhoto']").prettyPhoto({animation_speed:'fast',slideshow:10000, hideflash: true});
...
// one page navigation
		...
		jQuery('#gallery .item .icon-info').click(function(){
    ...
    ///////////////////////testloadedarea2/////////////////////
		...
		jQuery('#gallery2 .item .icon-info').click(function(){
		    jQuery('.page-overlay').show();
		    url = jQuery(this).attr("data-value");
			
		    jQuery("#loader-area2 .project-load").load(url, function() {
		        jQuery("#loader-area2").slideDown(500,function(){
		            jQuery('.page-overlay').hide();
		            jQuery('html, body').animate({
		                scrollTop: jQuery('#loader-area2').offset().top - 70
		            }, 500, 'easeOutCirc');
		            ...
		            jQuery('#btn-close-x2').click(function(){
		                jQuery("#loader-area2").slideUp(500,function(){
		                    jQuery('html, body').animate({				
		                        scrollTop: jQuery('#section-portfolio2').offset().top - 70
		                    }, 500, 'easeOutCirc');
		                });
